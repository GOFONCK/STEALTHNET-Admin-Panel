#!/usr/bin/env python3
"""
Скрипт миграции для добавления поддержки BTCPayServer в базу данных.
Добавляет колонки для BTCPayServer в таблицу payment_setting.

Использование:
    python3 migrate_add_btcpayserver.py
"""

...
- Payment: promo_code_id, payment_provider, payment_system_id
 - PaymentSetting: heleket_api_key, platega_merchant_id, platega_secret, platega_allowed_methods, telegram_bot_token, yookassa_shop_id, yookassa_secret_key
    ...
    with app.app_context():
        ...
        try:
            if not PaymentSetting.query.first():
                ...
                print("   - Platega (platega_merchant_id, platega_secret, platega_allowed_methods)")
